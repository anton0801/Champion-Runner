...
class Stage2Map: Stage {
    func buildStage(scene: RunnerGameScene, cameraNode: SKCameraNode) {
        let platform1 = PlatformBig(type: 2, size: CGSize(width: 600, height: 200))
        ...
        let platform2 = PlatformMedium(type: 2, size: CGSize(width: 400, height: 200))
        ...
        let platform4 = PlatformFlyingSmall(type: 2, isMovable: true, size: CGSize(width: 100, height: 140))
        platform4.position = CGPoint(x: 1150, y: 300)
        scene.addChild(platform4)
        
        let platform5 = PlatformFlyingMedium(type: 2, size: CGSize(width: 140, height: 180))
        platform5.position = CGPoint(x: 1000, y: 400)
        scene.addChild(platform5)
        
        let platform6 = PlatformFlyingBig(type: 2, size: CGSize(width: 180, height: 220))
        ...
        let platform7 = PlatformBig(type: 2, size: CGSize(width: 600, height: 200))

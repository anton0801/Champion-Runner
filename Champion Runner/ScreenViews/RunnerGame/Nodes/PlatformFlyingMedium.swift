...
class PlatformFlyingMedium: SKSpriteNode {
    
    init(type: Int, size: CGSize) {
        let platformNode = SKSpriteNode(imageNamed: "platform_\(type)_medium_flying")
        ...
        platformNode.name = "platform_\(type)_medium_flying"
